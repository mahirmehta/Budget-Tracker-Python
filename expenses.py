...
class expense_window(QWidget):
    ...
    def e_ui(self): 
      ...
      self.money.setMaximumSize(QSize(100,24))
      self.money1.setMaximumSize(QSize(100,24))
      self.money2.setMaximumSize(QSize(100,24))
      self.money3.setMaximumSize(QSize(100,24))
      self.money4.setMaximumSize(QSize(100,24))
      self.money5.setMaximumSize(QSize(100,24))
      self.money6.setMaximumSize(QSize(100,24))
